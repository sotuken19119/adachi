...
let timeIntervalId; 
export default function Timer({ gameOver, gameClear,setGameClear, sendTime , setOptionflg , optionflg, restartflg, setRestartFlg, endGame}) {
  ...
  return (
    ...
    <div style={{ color: "white", fontSize: 20, }}>
      ...
      {gameClear && <ModalClear completeTime={sTime} setGameClear={setGameClear} endGame={endGame}/>}
    </div>
  );
}